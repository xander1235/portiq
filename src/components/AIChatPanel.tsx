...
interface AIChatPanelProps {
  ...
  setResponseSummary: (summary: ResponseSummary | null) => void;
  response: any;
  isAiTyping: boolean;
  aiChatHistory: Message[];
  aiChatSessions: Session[];
  activeAiSessionId: string | null;
  setActiveAiSessionId: (id: string) => void;
  createNewAiSession: () => void;
  aiPrompt: string;
  setAiPrompt: (prompt: string) => void;
  handleAiChatSubmit: (customPrompt?: string | any) => void;
...
const CodeBlockWithCopy = ({ inline, className, children, ...props }: any) => {
